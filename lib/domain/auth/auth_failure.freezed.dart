...
class _$AuthFailureTearOff {
  ...
  UserAlreadySignedIn userAlreadySignedIn() {
    return const UserAlreadySignedIn();
  }
}
...
/// @nodoc
abstract class $UserAlreadySignedInCopyWith<$Res> {
  factory $UserAlreadySignedInCopyWith(
          UserAlreadySignedIn value, $Res Function(UserAlreadySignedIn) then) =
      _$UserAlreadySignedInCopyWithImpl<$Res>;
}

/// @nodoc
class _$UserAlreadySignedInCopyWithImpl<$Res>
    extends _$AuthFailureCopyWithImpl<$Res>
    implements $UserAlreadySignedInCopyWith<$Res> {
  _$UserAlreadySignedInCopyWithImpl(
      UserAlreadySignedIn _value, $Res Function(UserAlreadySignedIn) _then)
      : super(_value, (v) => _then(v as UserAlreadySignedIn));

  @override
  UserAlreadySignedIn get _value => super._value as UserAlreadySignedIn;
}

/// @nodoc

class _$UserAlreadySignedIn implements UserAlreadySignedIn {
  const _$UserAlreadySignedIn();
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is UserAlreadySignedIn);
  }
...
abstract class UserAlreadySignedIn implements AuthFailure {
